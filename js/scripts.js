const professionalsData = [
  ...
  },
  {
    ...
    especialidades: [
      "Organização Método Hygge",
      "Organização Residencial",
      "Treinamento de Limpeza Moderna",
      "Treinamento de Lavadoria",
      "Rotina Doméstica",
      "Consultoria de Organização de Mudança",
      "Consultoria de Compra de Produtos Organizadores",
      "Consultoria de Compra de Rouparia",
      "Palestras e Workshops",
      "Atendimento Presencial em Mogi das Cruzes, Região e São Paulo",
    ],
